...
// 评论审核通过
router.post('/comment_pass', adminController.comment_Check, adminController.comment_pass)
// 评论审核不通过
router.post('/comment_reject', adminController.comment_Check, adminController.comment_reject)
// 删除评论
router.post('/comment_delete', adminController.comment_Check, adminController.comment_delete)
// 获取用户信息userinfo_get
